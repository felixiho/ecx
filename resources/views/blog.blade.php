...
<section class="wow fadeIn parallax" data-stellar-background-ratio="0.5" style="background-image:url('/customimg/smallbooks.jpg');">
            ...
            <main class="col-md-9 col-sm-12 col-xs-12 right-sidebar sm-margin-60px-bottom xs-margin-40px-bottom no-padding-left sm-no-padding-right">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 blog-post-content margin-60px-bottom xs-margin-30px-bottom xs-text-center">
                    ...
                    <div class="blog-text border-all display-inline-block width-100">
                        <div class="content padding-50px-all xs-padding-20px-all">
                            ...
                            <a href="blog-standard-post.html" class="text-extra-dark-gray text-uppercase  alt-font text-large font-weight-600 margin-15px-bottom display-block">Taxation; the good, bad and ugly.</a>
                            ...
                            <div class="name col-md-4 col-sm-4 padding-15px-all">
                                <div class="display-table text-center width-100 height-100">
                                    <div class="display-table-cell vertical-align-middle">
                                        ...
                                        <span class="text-medium-gray text-uppercase text-extra-small alt-font padding-10px-left">by <a href="blog-grid.html" class="text-medium-gray">Paul Nwokoma</a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 blog-post-content margin-60px-bottom xs-margin-30px-bottom xs-text-center">
                    ...
                    <div class="blog-text border-all display-inline-block width-100">
                        <div class="content padding-50px-all xs-padding-20px-all">
                            <div class="text-medium-gray text-extra-small margin-5px-bottom text-uppercase alt-font"><span>Posted on June 30, 2017</span>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<span><a href="blog-grid.html" class="text-medium-gray ">Branding</a></span></div>
                            <a href="blog-standard-post.html" class="text-extra-dark-gray text-uppercase  alt-font text-large font-weight-600 margin-15px-bottom display-block">Managing Crisis in the workplace</a>
                            <p class="no-margin">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry industry’s standard dummy text Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text.</p>
                        </div>
                        <div class="equalize xs-equalize-auto author border-top border-color-extra-light-gray display-table width-100">
                            <div class="name col-md-4 col-sm-4 padding-15px-all">
                                <div class="display-table text-center width-100 height-100">
                                    <div class="display-table-cell vertical-align-middle">
                                        <img src="http://placehold.it/149x149" alt="" class="border-radius-100 width-30px">
                                        <span class="text-medium-gray text-uppercase text-extra-small alt-font padding-10px-left">by <a href="blog-grid.html" class="text-medium-gray">Okeke Felix</a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <aside class="col-md-3 col-sm-12 col-xs-12 pull-right">
                ...
                <div class="margin-45px-bottom xs-margin-25px-bottom">
                    ...
                    <ul class="list-style-6 margin-50px-bottom text-small">
                        <li><a href="blog-masonry.html">Financing</a><span>12</span></li>
                        <li><a href="blog-masonry.html">Accounting</a><span>05</span></li>
                        <li><a href="blog-masonry.html">Employee</a><span>08</span></li>
                    </ul>
                </div>
                <div class="bg-deep-pink padding-30px-all text-white text-center margin-45px-bottom xs-margin-25px-bottom">
                    ...
                    <a class="btn btn-very-small btn-transparent-white border-width-1 text-uppercase" href="{{URL('/get-started')}}">Get Started</a>
                </div>
                <div class="margin-45px-bottom xs-margin-25px-bottom">
